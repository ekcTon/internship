<?php
    ...
    $sql = "SELECT * FROM news where status ='true' and type = 'news' and (upper(title) = '$word' or lower(title) = '$word' or title Like '%$word%' or upper(content) = '$word' or lower(content) = '$word' or content Like '%$word%' ) order by id desc";
